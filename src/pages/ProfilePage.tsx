    ...
    <div className="min-h-screen pt-20 pb-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card rounded-2xl p-8 mb-8">
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="text-center sm:text-left flex-1">
              <h1 className="font-display text-3xl font-bold text-foreground">Demo User</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { icon: Package, label: t("profile.products"), value: "12" },
            { icon: Handshake, label: t("profile.exchanges"), value: "8" },
            { icon: Star, label: t("profile.rating"), value: "4.0" },
          ].map((stat, i) => (
